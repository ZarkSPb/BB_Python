...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ButtonSave.clicked.connect(MainWindow._save_file)
        ...
        self.actionSave_File.triggered.connect(MainWindow._save_file)
...
#if QT_CONFIG(shortcut)
        self.actionRhytm_window.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+R", None))
#endif // QT_CONFIG(shortcut)
